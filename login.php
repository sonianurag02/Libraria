...
<body>
            ...
            <div class="box1">
                ...
                <form name="login" action="" method="post">
                    ...
                    <p style="color: white; padding-left: 15px;">
                        <br><br>
                        <!-- <a style="color: cyan; text-decoration: none;" href="update_password.php"> Forgot password </a> -->
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        New to this website?
                        <a style="color: cyan; text-decoration: none; float:right;" href="registration.php">Sign Up</a>
                    </p>
                </form>
            </div>
        </div>
    ...
    if(isset($_POST['submit'])){
        if($_POST['user']=='admin'){
            ...
            if($count==0){
                ?>
                <div class="alert alert-danger" style="width: 700px; margin-left: 420px; margin-top: 20px;
                background-color: #ec0d0d; color: white;">
                    <strong> The username or password doesn't matched. </strong>
                </div>
                <?php
            }
            else{
