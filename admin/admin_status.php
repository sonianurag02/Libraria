...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            $q=mysqli_query($db,"SELECT first, last, username, email, contact FROM `admin` WHERE username like '%$_POST[search]%' and
            status='' ");
            if(mysqli_num_rows($q)==0){
                ...
                ?>
                <form method="post">
                    <button type="submit" name="submit1" style="background-color: #c7c6c6; color: red; font-weight: 700; font-size: 18px;" class="btn btn-default">
                        <span style=" color: red;" class="glyphicon glyphicon-remove-sign"> REMOVE </span>
                    </button>
                    <button type="submit" name="submit2" style="background-color: #c7c6c6; color: green; font-weight: 700; font-size: 18px;" class="btn btn-default">
                        <span style="color: green;" class="glyphicon glyphicon-ok-sign"> APPROVE </span>
                    </button>
                </form>
                <?php
            }
