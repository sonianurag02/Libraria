...
<body>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    ?>
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" style="color: white; font-weight: bold; font-size: 1.2em;">Contact us</a>
                                </li>
                                <li class="nav-item">
                    ...
                    ?>
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                            <a class="nav-link" href="login.php" style="color: white; font-weight: bold; font-size: 1.2em;">Login</a>
                            </li>
                        </ul>
                    <?php
                        }
	...
	<section class="contactme" id="Contact">
		<div class="total-contactme">
			<div class="header2">
				<h1 class="header1 heading"> Contact me </h1>
	...
	<footer class="footersection">
		<div class="total-footersection">
			<div class="col-lg-8 col-md-8 col-10 offset-lg-2 offset-md-2 col-1 footer-div">
				<p>Copyright ©2k22 ANURAG SONI...<br> All rights reserved....</p>
			</div>
		</div>
